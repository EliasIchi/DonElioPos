...
Así está casi perfecto

Lo único al momento de filtros de reporte de ventas. Tenemos un problema en la base a veces se guardan como Efectivo y otras como EFECTIVO

en la consulta SQL podríamos poner un Upper? Y así mismo en las cols de filtro ?cols = ["Pedido","Cliente","Teléfono","Dirección","Total","MedioPago","fecha_inicio"]
